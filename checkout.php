...
<div class='flex items-start justify-center min-h-screen p-4'> <!-- Start of container div -->
    <?php if ($result->num_rows > 0) {
        ...
        <div class='w-1/2 pl-8'>
            <h1 class='text-2xl font-bold mb-4'><?php echo $product['name']; ?></h1><!-- Product name -->
            <p class='text-gray-600 text-sm mb-4'><?php echo $product['details']; ?></p><!-- Product details -->
            <p class='text-lg font-semibold mb-2'>Price: $<?php echo $product['price']; ?></p><!-- Product price with "Price" label -->
            ...
            <div class='flex items-center '>
                <button id='buy-item-button'
                        class='px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 mt-0' type='button'>Buy
                    Item
                </button>
            </div>
            ...
            <h2 class='text-xl font-semibold mt-4'>More Items:</h2>
    ...
    &times;
            ...
            <form action="paymentvalidation.php" method="post" class="bg-white shadow-md rounded px-4 py-6 mt-4 md:w-1/2 mx-auto">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="cardNumber" name="cardNumber" type="text" placeholder="Card Number">
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="cardName">Name on card</label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                           id="cardName" name="cardName" type="text" placeholder="Name on Card">
                </div>
                <div class="flex -mx-4 mb-4">
                    <div class="w-1/2 px-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                               id="cardExpiry" name="cardExpiry" type="text" placeholder="MM/YY">
                    </div>
                    <div class="w-1/2 px-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="cardCVC">Security Code (CVC)</label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                               id="cardCVC" name="cardCVC" type="text" placeholder="CVC">
                    </div>
                </div>
